    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/Savvy_robot_support"),
                        InlineKeyboardButton("Bots Channel", url="https://t.me/savvy_robot_Updates")
                    ],
                    [
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/Savvy_robot_support)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=ranavanshi_divy_{str_to_b64(file_er_id)}"
...
#-------------AUTO_CAPTION_FEATURE------------------#
@Bot.on_message(pyrogram.filters.channel)
                ...
                [
                    [
                        InlineKeyboardButton("Contact Owner",
                                             url="https://instagram.com/noob_savvy")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Savvy_robot_support).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/Savvy_robot_support).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
